...
### 1. Web Development Essentials (Crash Course)
...
### 5. Django Architecture Overview
...
### 7. Templates (Django Templating Language)
...
### 11. Forms (HTML Forms, Validation, UX)
...
### 13. Middleware, Sessions, Messages, and Cookies
...
### 16. Project 1 (Beginner): Blog/Content Site
...
### 17. Project 2 (Intermediate): Multi-User App (Tasks/CRM/Inventory)
...
### 20. Performance and Scaling Fundamentals
...
### 22. Architecture and Code Organization
...
### 24. Django REST Framework (DRF) Core
...
### 26. API Security and Production Concerns
...
### 27. ASGI, Async Views, and Django’s Async Capabilities
1. WSGI vs ASGI
...
### 28. Realtime with WebSockets (Django Channels)
...
### 29. Background Tasks (Celery/RQ Concepts)
...
### 31. Advanced Migrations and Data Management
...
### 33. Search, Files, and External Services
...
### 41. Multi-Tenancy Patterns (SaaS Architectures)
...
### 42. Advanced Authorization (Policy-Based Access)
...
### 46. Advanced Testing and Quality Engineering
...
### 48. Capstone A: Content Platform (Publishing + Membership)
...
### 49. Capstone B: SaaS CRUD Platform (Multi-Tenant + API)
1. Multi-tenant architecture
2. DRF API + docs + versioning
3. Background jobs + email notifications
4. CI/CD + production runbooks

### 50. Capstone C: Realtime App (Notifications/Chat)
1. Channels + Redis
